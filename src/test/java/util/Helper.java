...
public class Helper {
    ...
    public static void randClick(By locator) throws InterruptedException {
        Thread.sleep(2000);
    ...
    public static void randomSelectProduct(String categories, String appPackage, String filterWiz, String prodWiz) throws InterruptedException {
